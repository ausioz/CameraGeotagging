...
import com.example.camerageotagging.KEY_EVENT_ACTION
import com.example.camerageotagging.KEY_EVENT_EXTRA
import com.example.camerageotagging.R
import com.example.camerageotagging.databinding.CameraUiContainerBinding
import com.example.camerageotagging.databinding.FragmentCameraBinding
import com.example.camerageotagging.location.ForegroundOnlyLocationService
import com.example.camerageotagging.utils.ANIMATION_FAST_MILLIS
import com.example.camerageotagging.utils.ANIMATION_SLOW_MILLIS
import com.example.camerageotagging.utils.MediaStoreUtils
import com.example.camerageotagging.utils.simulateClick
import com.example.camerageotagging.utils.toText
...
//        val outputWithPreviousLogs = "$output\n${cameraUiContainerBinding?.locationTV?.text}"
        cameraUiContainerBinding?.locationTV?.text = output
    }

    private fun getLocation(getLocation: Location) {
